                                ...
                                <div class="card border-0 rounded-0 text-light overflow zoom">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                            ...
                                            <a href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">
                                                <h2 class="h3 post-title text-white my-1">Bien venue dans cinq etoiles Garage_pro Moderne La Refference</h2>
                                            </a>
                                ...
                                <div class="card border-0 rounded-0 text-light overflow zoom">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                            <!--title and description-->
                                            <a href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">
                                                <h2 class="h3 post-title text-white my-1">Nous avons tout ce qu'il faut rassurez-vous</h2>
                                            </a>
                                ...
                                <div class="card border-0 rounded-0 text-light overflow zoom">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                            <!--title and description-->
                                            <a href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">
                                                <h2 class="h3 post-title text-white my-1">les Hommes certifiés les méhieurs dans le domaine </h2>
                                            </a>
                                ...
                                <div class="card border-0 rounded-0 text-light overflow zoom">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                            <!--title and description-->
                                            <a href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">
                                                <h2 class="h3 post-title text-white my-1">premier dans l'union Euro</h2>
                                            </a>
