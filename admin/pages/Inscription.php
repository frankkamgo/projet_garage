...
?>
    <div class="block-30 block-30-sm item" style="background-image: url('./Admin/images/');" data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-10">
                <span class="subheading-sm">Ajout client </span>
                <h2 class="heading">Ajout</h2>
            </div>
        </div>
    </div>
</div>
  ...
  <div class="form-row">
   ...
   <div class="form-row">
    ...
    <input type="submit" value="Ajouter" class="btn btn-primary" name="Inscription" id="Inscription">
